...
struct Ptr64
{
  ...
  inline operator T*(void) { return p; }
  /// overloading the cast to char
  inline operator char*(void) { return (char*)p; }
  /// overloading the field access of the pointer
  inline T* operator->(void) { return p; }
